...
function Admin() {
  return (
    <div className="mx-auto bg-grey-400">
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <header className="bg-nav bg-[#333333]">
        ...
        <AdminSidebar>
          ...
          <main className="bg-white-300 flex-1 p-3 overflow-hidden">
            <div className="flex flex-col">
              ...
              <div className="flex flex-1 lg:flex-row mx-2">
                <div className="shadow-lg bg-pink-400 border-l-8  border-pink-700 mb-2 p-2 w-1/4 mx-2">
                  <div className="p-4 flex flex-col">
                    <p className="no-underline font-semibold font-poppins text-black text-2xl">
                      1,600
                </p>
                    <p className="no-underline font-semibold font-poppins text-black text-lg">
                      Hotels across India
                </p>
                  </div>
                </div>
                <div className="shadow-lg bg-cyan-400 border-l-8  border-blue-800 mb-2 p-2 w-1/4 mx-2">
                  <div className="p-4 flex flex-col">
                    <p className="no-underline font-semibold font-poppins text-black text-2xl">
                      1,12,367
                </p>
                ...
                <div className="shadow-lg bg-amber-500 border-l-8  border-amber-700 mb-2 p-2 w-1/4 mx-2">
                  <div className="p-4 flex flex-col">
                    <p className="no-underline font-semibold font-poppins text-black text-2xl">
                      22,341
                </p>
                ...
                <div className="shadow-lg bg-lime-500 border-l-8  border-lime-700 mb-2 p-2 w-1/4 mx-2">
                  <div className="p-4 flex flex-col">
                    <p className="no-underline font-semibold font-poppins text-black text-2xl">
                      ₹ 22,61,345
                </p>
  ...
  <div className="px-6 py-2 mt-[20px] border-b border-light-grey">
        ...
        <tr>
          ...
          <td>
            <span className="text-green-500"><i className="fas fa-arrow-up" />5%</span>
              ...
              <div className="flex flex-1 flex-col md:flex-row lg:flex-row mx-2 p-1 mt-2 lg:mx-2 md:mx-2 justify-between">
