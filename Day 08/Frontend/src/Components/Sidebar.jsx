        ...
        <>
            <aside className="h-screen">
                <nav className="h-full flex flex-col bg-white border-r shadow-sm">
                    ...
                    <img
    src="https://res.cloudinary.com/dnq6fx1oj/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1710938733/Pngtree_summer_beach_logo_5442586_scz2fm.png"
    className={`overflow-hidden py-[20px] transition-all ${expanded ? "w-[175px]" : "w-0"}`}
    style={{
