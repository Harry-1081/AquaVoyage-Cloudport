...
import LandingComponent1 from "../LandingPage/LandingComponent1"
import LandingComponent2 from "../LandingPage/LandingComponent2"
import LandingComponent4 from "../LandingPage/LandingComponent4"
    ...
    return(
        <>
            ...
            <div className="bg-blue-50 h-full flex flex-col justify-center items-center">
                ...
                <div className="bg-url('https://res.cloudinary.com/dnq6fx1oj/image/upload/v1710479919/Mandarin-Oriental-Jumeira-1536x1152_tr2pal.jpg') h-screen mt-[30px] w-[90%] rounded-[20px]">
