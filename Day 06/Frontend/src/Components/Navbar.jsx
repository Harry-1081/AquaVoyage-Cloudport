    ...
    return (
          ...
          <div className="flex-col flex">
            <div className="w-full border-b-2 border-gray-200">
              <div className="bg-white h-16 justify-between items-center mx-auto px-4 flex">
                <div>
                  <img src="https://res.cloudinary.com/dnq6fx1oj/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1710938733/Pngtree_summer_beach_logo_5442586_scz2fm.png"
                    className="block h-8 w-auto" alt="" />
                </div>
      ...
      <div className="relative" ref={menuRef}>
        <div className="cursor-pointer" onClick={() => setOpen(!open)}>
          <img src={user} alt="User" className="h-[40px] mr-[20px] transform hover:scale-110 transition duration-700" />
        </div>

        <div className={`absolute right-0 mt-2 mr-[150px] bg-cyan-100 z-50 shadow-lg rounded-md ${open ? 'block' : 'hidden'}`}>
          <div className="p-4">
          <img src={user} alt="User" className="h-[40px] pb-[10px] transform hover:scale-110 transition duration-700" />
