...
const ForgotPassword = () => {
    ...
    return (
        ...
        style={{ backgroundImage: `url('https://github.com/nive-2003/AAD_PVT/blob/main/src/assets/bg2.jpeg?raw=true)` }}>
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gray-700 bg-opacity-75 shadow-2xl rounded-2xl p-[30px] md:p-14">
                <h1 className="text-3xl text-white font-bold font-poppins mb-[30px]">Change Password</h1>
